...
@section('content')
    <div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
        <h1 class="text-2xl font-bold mb-4">Update Clients</h1>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="document_type" id="document_type" class="w-full px-4 py-2 border rounded">
                        ...
                        <option value="PASSPORT" {{ $customer->document_type == "PASSPORT" ? 'selected' : '' }}>PASSPORT</option>
                        <option value="RIF" {{ $customer->document_type == "RIF" ? 'selected' : '' }}>RIF</option>
                    </select>
                </div>
                <div>
